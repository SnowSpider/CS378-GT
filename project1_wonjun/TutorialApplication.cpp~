...
void TutorialApplication::createScene(void)
{
    ...
    // Create game objects
    tempObject = GameObject(mSceneMgr, &simulator, btVector3(0,0,0), "sphere.mesh", "Examples/PlasmaShit"); 
    ...
    tempObject = GameObject(mSceneMgr, &simulator, btVector3(0,100,0), "plane_y_pos_in", "MyMaterials/wood3");
    ...
    tempObject = GameObject(mSceneMgr, &simulator, btVector3(0,-100,0), "plane_y_neg_in", "MyMaterials/wood3");
    tempObject.shape = new btStaticPlaneShape(btVector3(0,1,0), 0);
    tempObject.addToSimulator();
    m_objects.push_back(tempObject);
