...
void MenuState::enter()
{
    ...
    OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "SingleBtn", "Singleplayer Game", 250);
    OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "MultiBtn", "Multiplayer Game", 250);
