...
void PauseState::enter()
{
    ...
    OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "BackToSingleGameBtn", "Return to SingleGameState", 250);
...
void PauseState::buttonHit(OgreBites::Button *button)
{
    ...
    else if(button->getName() == "BackToSingleGameBtn")
    {
        //popAllAndPushAppState(findByName("SingleGameState"));
        m_bQuit = true;
    }
