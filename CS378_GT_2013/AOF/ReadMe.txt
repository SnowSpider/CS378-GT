          ...
          <div class="aui-header-secondary">
              ...
              <ul role="menu" class="aui-nav">
                ...
                <li>
                  ...
                  <li id="user-options">
                    <a href="/account/signin/?next=/spacegaier/advancedogreframework/src/d24a1662021a2ca899990513e45bc2477cbd9339/ReadMe.txt%3Fat%3Ddefault" class="aui-nav-link login-link">Log in</a>
                  </li>
...
<header id="source-path">
  ...
  <div class="labels labels-csv">
    ...
    <div class="view-switcher">
      <div class="aui-buttons">
          ...
          <a href="/spacegaier/advancedogreframework/src/d24a1662021a/ReadMe.txt?at=default"
             class="aui-button aui-style pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/spacegaier/advancedogreframework/diff/ReadMe.txt?diff2=d24a1662021a&at=default"
             class="aui-button aui-style pjax-trigger"
             title="Diff to previous change">
            Diff
          </a>
          <a href="/spacegaier/advancedogreframework/history-node/d24a1662021a/ReadMe.txt?at=default"
             class="aui-button aui-style pjax-trigger">
            History
          </a>
  ...
  <h1>
    <a href="/spacegaier/advancedogreframework/src/d24a1662021a?at=default"
       class="pjax-trigger" title="[u&#39;ReadMe.txt&#39;]">AdvancedOgreFramework</a> /
...
<span class="aui-icon-dropdown"></span>
          ...
          <div class="secondary">
              ...
              <div class="aui-buttons">
                <a href="/spacegaier/advancedogreframework/annotate/d24a1662021a2ca899990513e45bc2477cbd9339/ReadMe.txt?at=default"
                   class="aui-button aui-style pjax-trigger">Blame</a>
              </div>
            
            <div class="aui-buttons">
              
              <a href="/spacegaier/advancedogreframework/full-commit/d24a1662021a/ReadMe.txt" class="aui-button aui-style"
                 title="View full commit d24a166">Full commit</a>
              
                
                <a id="embed-link" href="https://bitbucket.org/spacegaier/advancedogreframework/src/d24a1662021a2ca899990513e45bc2477cbd9339/ReadMe.txt?embed=t"
                   class="aui-button aui-style">Embed</a>
              
              <a href="/spacegaier/advancedogreframework/raw/d24a1662021a2ca899990513e45bc2477cbd9339/ReadMe.txt"
...
<a href="#cl-49">49</a>
<a href="#cl-50">50</a>
<a href="#cl-51">51</a></pre></div></td><td class="code"><div class="highlight"><pre><a name="cl-1"></a>==============================================================================           
<a name="cl-2"></a>             _                               _    ____                 
<a name="cl-3"></a>    /\      | |                             | |  / __ \                
<a name="cl-4"></a>   /  \   __| |_   ____ _ _ __   ___ ___  __| | | |  | | __ _ _ __ ___ 
<a name="cl-5"></a>  / /\ \ / _` \ \ / / _` | &#39;_ \ / __/ _ \/ _` | | |  | |/ _` | &#39;__/ _ \
<a name="cl-6"></a> / ____ \ (_| |\ V / (_| | | | | (_|  __/ (_| | | |__| | (_| | | |  __/
<a name="cl-7"></a>/_/    \_\__,_| \_/ \__,_|_| |_|\___\___|\__,_|  \____/ \__, |_|  \___|
<a name="cl-8"></a>                                                         __/ |         
<a name="cl-9"></a>                                                        |___/          
<a name="cl-10"></a> ______                                           _    
<a name="cl-11"></a>|  ____|                                         | |   
<a name="cl-12"></a>| |__ _ __ __ _ _ __ ___   _____      _____  _ __| | __
<a name="cl-13"></a>|  __| &#39;__/ _` | &#39;_ ` _ \ / _ \ \ /\ / / _ \| &#39;__| |/ /
<a name="cl-14"></a>| |  | | | (_| | | | | | |  __/\ V  V / (_) | |  |   &lt; 
<a name="cl-15"></a>|_|  |_|  \__,_|_| |_| |_|\___| \_/\_/ \___/|_|  |_|\_\                                                       
<a name="cl-16"></a>
<a name="cl-17"></a>
<a name="cl-18"></a>==============================================================================
<a name="cl-19"></a>
<a name="cl-20"></a>created by: 
<a name="cl-21"></a>        Philip Allgaier &lt;spacegaier&gt;       
<a name="cl-22"></a>        spacegaier@ogre3d.org                                                
<a name="cl-23"></a>
<a name="cl-24"></a>==============================================================================
<a name="cl-25"></a>
<a name="cl-26"></a>An out-of-the-box running advanced framework of an Ogre application, offering:
<a name="cl-27"></a>
<a name="cl-28"></a>    * Ogre initialization
<a name="cl-29"></a>    * game/application state framework
<a name="cl-30"></a>    * custom render loop
<a name="cl-31"></a>    * DotScene / XML scene loading
<a name="cl-32"></a>    * different keyboard input modes (buffered vs. unbuffered)
<a name="cl-33"></a>    * user interface
<a name="cl-34"></a>    * in-code material manipulations 
<a name="cl-35"></a>    * ray scene queries with query masks
<a name="cl-36"></a>
<a name="cl-37"></a>The framework is explained in the Ogre wiki: 
<a name="cl-38"></a>http://ogre3d.org/tikiwiki/Advanced+Ogre+Framework
<a name="cl-39"></a>
<a name="cl-40"></a>Please post all issues and questions here: 
<a name="cl-41"></a>http://www.ogre3d.org/forums/viewtopic.php?f=5&amp;t=51994
<a name="cl-42"></a>
<a name="cl-43"></a>==============================================================================
<a name="cl-44"></a>
<a name="cl-45"></a>Usage:
<a name="cl-46"></a>1. Start the application
<a name="cl-47"></a>2. Select your preferred graphics options
<a name="cl-48"></a>3. Press the menu buttons to get to the desired application state
<a name="cl-49"></a>4. Follow the on-screen instructions and keyboard controls
<a name="cl-50"></a>
<a name="cl-51"></a>==============================================================================
</pre></div>
</td></tr></table>
...
<a href="/spacegaier/advancedogreframework/src/[[raw_node]]/ReadMe.txt?at=default"
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
          [[#hasMultipleHeads]]
            [[#heads]]
              <li class="comprev filter-item">
                <a href="/spacegaier/advancedogreframework/src/[[changeset]]/ReadMe.txt?at=[[safeName]]"
                   title="[[name]]">
                  [[name]] ([[shortChangeset]])
                </a>
              </li>
          ...
          [[^hasMultipleHeads]]
            <li class="comprev filter-item">
              <a href="/spacegaier/advancedogreframework/src/[[changeset]]/ReadMe.txt?at=[[safeName]]" title="[[name]]">
                [[name]]
              </a>
            </li>
          [[/hasMultipleHeads]]
  ...
  <footer id="footer" role="contentinfo">
    <section class="footer-body">
      ...
      <ul>
        ...
        <li><a href="#">1a0ea496d75b / 9e262ba34f96 @ bitbucket15</a></li>
      </ul>
    </section>
  </footer>
</div>
